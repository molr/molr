...
public class MolrWebSocketClientImpl implements MolrWebSocketClient{
    ...
    @Override
    public <I> Publisher<MissionEvent> instantiate(String missionName, String missionId, I args){
        InstantiationRequest<I> request= new InstantiationRequest<>(missionId, missionName, args);
