...
public class ExecutionStrategyConfiguration {
    ...
    private ExecutionStrategyConfiguration(ExecutionStrategy defaultStrategy,
            Set<ExecutionStrategy> allowedStrategies) {
    ...
    public static class Builder {
        ...
        public Builder defaultsTo(ExecutionStrategy executionStrategy) {
            if (this.defaultStrategy != null)
                throw new IllegalStateException("defaultsTo must not be called twice.");
            defaultStrategy = executionStrategy;
            return this;
        }

        public Builder allowedStrategies(Set<ExecutionStrategy> newAllowedStrategies) {
            if (this.allowedStrategies != null)
                throw new IllegalStateException("allowedStrategies must not be called twice.");
            this.allowedStrategies = newAllowedStrategies;
            return this;
        }
        ...
        ExecutionStrategyConfiguration build() {
            ...
            if (allowedStrategies.size() == 0) {
                throw new IllegalArgumentException(
                        "At least one Strategy has to be specified as allowed execution strategy.");
            }
            if (defaultStrategy == null) {
            ...
            throw new IllegalArgumentException(MessageFormat.format("Default strategy {0} is not a member of {1}",
                    defaultStrategy, allowedStrategies));
        }
