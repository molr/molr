 ...
 */
@Component
public class MolrServerInstructHandler implements WebSocketHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(MolrServerInstructHandler.class);

    private final ServerExecutionService service;

    public MolrServerInstructHandler(ServerExecutionService service) {
