...
public interface RemoteMoleSupervisor {
     ...
     */
    <I> Flux<MoleExecutionEvent> instantiate(String missionClassName, I args, String missionExecutionId);


    /**
     * A method which should send a command request to the supervisor
